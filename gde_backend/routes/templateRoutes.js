...
router.post('/create', authMiddleware, requirePermission('admin_manage_templates'), templateController.createTemplate);
router.put('/update/:id', authMiddleware, requirePermission('admin_manage_templates'), templateController.updateTemplate);
router.delete('/delete/:id', authMiddleware, requirePermission('admin_manage_templates'), templateController.deleteTemplate);
