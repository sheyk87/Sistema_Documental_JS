...
async function sendNotificationInternal({ userIds, senderId, action, message, itemId, itemType }) {
    ...
    if (expandedUserIds.size === 0) return;
...
exports.createNotification = async (req, res) => {
    ...
    try {
        await sendNotificationInternal({ userIds, senderId, action, message, itemId, itemType });
